...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey('self', null=True, on_delete=models.SET_NULL, related_name='next_evolution', verbose_name='Из кого эволюционировал')
...
class PokemonEntity(models.Model):
    ...
    appeared_at = models.DateTimeField(default=None, verbose_name='Появится')
    disappeared_at = models.DateTimeField(default=None, verbose_name='Исчезнет')
