...
class PokemonEntity(models.Model):
    ...
    level = models.IntegerField(default=1, blank=True, verbose_name='Уровень')
    health = models.IntegerField(default=1, blank=True, verbose_name='Здоровье')
    strength = models.IntegerField(default=1, blank=True, verbose_name='Сила')
    defence = models.IntegerField(default=1, blank=True, verbose_name='Защита')
    stamina = models.IntegerField(default=1, blank=True, verbose_name='Выносливость')
